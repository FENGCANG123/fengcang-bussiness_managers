    ...
    <ul class="nav sidebar-nav">
        ...
        <li class="dropdown open">
            ...
            <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="/business/user/product/find/0">列表</a></li>
        ...
        <li class="dropdown open">
            ...
            <ul class="dropdown-menu" role="menu">
                <li class="dropdown-header">操作</li>
                <li><a href="/business/user/category/find/0">列表</a></li>
        ...
        <li class="dropdown open">
            ...
            <ul class="dropdown-menu" role="menu">
                <li class="dropdown-header">操作</li>
                <li><a href="/business/user/find/0">列表</a></li>
                <li><a href="/business/user/insert">新增</a></li>
            </ul>
        </li>

        <li>
            <a href="/business/user/logout"><i class="fa fa-fw fa-list-alt"></i> 登出</a>
        </li>
    </ul>
</nav>